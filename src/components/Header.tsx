    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24 sm:h-28">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link
              to="/contact"
              className="hidden md:inline-flex items-center justify-center px-6 py-3 text-sm font-semibold text-white bg-[#83997d] rounded-full hover:bg-[#83997d]/90 transition-colors duration-200 shadow-lg shadow-[#83997d]/25 focus:outline-none focus:ring-2 focus:ring-[#83997d] focus:ring-offset-2"
            >
              Get Help Now
            </Link>
          </motion.div>
      ...
      >
        <div className="px-4 py-6 space-y-4">
          ...
          <Link
            to="/contact"
            className="block mt-4 px-6 py-3 text-sm font-semibold text-center text-white bg-[#83997d] rounded-full hover:bg-[#83997d]/90 transition-colors duration-200"
          >
            Get Help Now
          </Link>
        </div>
