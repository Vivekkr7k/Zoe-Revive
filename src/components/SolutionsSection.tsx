      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 w-full">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <motion.div
            ...
            className="rounded-3xl p-8 lg:p-10 shadow-lg hover:shadow-xl transition-shadow duration-300"
          ...
          <motion.div
            ...
            whileHover={{ y: -8, transition: { duration: 0.2 } }}
            className="bg-[#83997d] rounded-3xl p-8 lg:p-10 shadow-lg hover:shadow-xl transition-shadow duration-300 text-white"
          >
