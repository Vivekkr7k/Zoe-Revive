      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#83997d]/20 to-transparent" />
          </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Physical Aspects</h3>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Mental and Emotional Aspects</h3>
            <p className="text-white/90 leading-relaxed mb-4">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Spiritual Aspects</h3>
            <p className="text-white/90 leading-relaxed mb-4">
        ...
        <motion.div
          ...
          style={{ backgroundColor: '#83997d' }}
        >
          <h3 className="text-3xl font-bold text-white mb-6">So What Happens?</h3>
          <div className="space-y-4 text-white">
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-2 h-2 bg-[#83997d] rounded-full mt-2" />
        ...
        <motion.div
          ...
          style={{ backgroundColor: '#83997d' }}
        >
          <h3 className="text-2xl font-bold text-white mb-6">Educational Resources</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-white mb-3">Articles & Research</h4>
              <ul className="space-y-2 text-white/90">
                <li>
                  <a href="https://www.ncbi.nlm.nih.gov/books/NBK549783/" target="_blank" rel="noopener noreferrer" className="hover:text-white underline">
                    Alcohol Use Disorder - NIH Research
                  </a>
                </li>
                <li>
                  <a href="https://www.who.int/news-room/fact-sheets/detail/alcohol" target="_blank" rel="noopener noreferrer" className="hover:text-white underline">
                    WHO Fact Sheet on Alcohol
                  </a>
                </li>
                <li>
                  <a href="https://www.mayoclinic.org/diseases-conditions/alcohol-use-disorder" target="_blank" rel="noopener noreferrer" className="hover:text-white underline">
            ...
            <div>
              <h4 className="font-semibold text-white mb-3">Documentaries & Videos</h4>
              <ul className="space-y-2 text-white/90">
                <li>
                ...
                <li>
                  <a href="https://www.youtube.com/results?search_query=alcohol+addiction+recovery+documentary" target="_blank" rel="noopener noreferrer" className="hover:text-white underline">
                    Recovery Documentaries on YouTube
                  </a>
                </li>
                <li>
                  <a href="https://www.youtube.com/results?search_query=alcohol+recovery+success+stories" target="_blank" rel="noopener noreferrer" className="hover:text-white underline">
                    Alcohol Recovery Success Stories
                  </a>
                </li>
              </ul>
            </div>
