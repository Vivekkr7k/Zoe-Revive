      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative rounded-2xl overflow-hidden shadow-xl">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#83997d]/60 to-transparent" />
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h3 className="text-3xl font-bold text-[#83997d] mb-8">Common Triggers for Relapse</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 border-l-4 border-[#83997d]">
              <div className="flex items-center mb-3">
                <svg className="w-6 h-6 text-[#83997d] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                </svg>
                <h4 className="font-semibold text-[#83997d]">Stress</h4>
              </div>
            ...
            <div className="bg-white rounded-xl p-6 border-l-4 border-[#83997d]">
              <div className="flex items-center mb-3">
                ...
                <h4 className="font-semibold text-[#83997d]">Social Settings</h4>
              </div>
              <p className="text-neutral-600 text-sm">
            ...
            <div className="bg-white rounded-xl p-6 border-l-4 border-[#83997d]">
              <div className="flex items-center mb-3">
                ...
                <h4 className="font-semibold text-[#83997d]">People & Places</h4>
              </div>
              <p className="text-neutral-600 text-sm">
            ...
            <div className="bg-white rounded-xl p-6 border-l-4 border-[#83997d]">
              <div className="flex items-center mb-3">
                ...
                <h4 className="font-semibold text-[#83997d]">Strong Emotions</h4>
              </div>
              <p className="text-neutral-600 text-sm">
            ...
            <div className="bg-white rounded-xl p-6 border-l-4 border-[#83997d]">
              <div className="flex items-center mb-3">
                ...
                <h4 className="font-semibold text-[#83997d]">Boredom</h4>
              </div>
              <p className="text-neutral-600 text-sm">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="mb-16 bg-gradient-to-br from-white to-white rounded-2xl p-8 md:p-12"
        >
          <h3 className="text-3xl font-bold text-[#83997d] mb-8">Practical Ways to Help</h3>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-10 h-10 bg-[#83997d] rounded-full flex items-center justify-center text-white font-bold">
                  1
                </div>
                <div>
                  <h4 className="font-semibold text-[#83997d] mb-2">Build Awareness</h4>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-[#83997d] mb-2">Encourage a Plan</h4>
                  <p className="text-neutral-600 leading-relaxed">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-[#83997d] mb-2">Suggest Healthy Habits</h4>
                  <p className="text-neutral-600 leading-relaxed">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-[#83997d] mb-2">Offer Supportive Company</h4>
                  <p className="text-neutral-600 leading-relaxed">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-[#83997d] mb-2">Connect with Resources</h4>
                  <p className="text-neutral-600 leading-relaxed">
          ...
          <div className="mt-8 p-6 rounded-xl" style={{ backgroundColor: '#83997d' }}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="bg-white border-2 border-[#83997d] rounded-2xl p-8 md:p-12 shadow-lg"
        >
          <h3 className="text-3xl font-bold text-[#83997d] mb-8 text-center">
            Relapse Prevention Plan (Sample Template)
          </h3>
          
          <div className="space-y-8">
            <div className="bg-white rounded-xl p-6">
              <h4 className="text-xl font-bold text-[#83997d] mb-4 flex items-center">
              ...
              <div className="bg-white rounded-lg p-4 min-h-[100px] border-2 border-dashed border-[#83997d]">
          ...
          <div className="mt-8 p-6 rounded-xl text-center" style={{ backgroundColor: '#83997d' }}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="mt-16 rounded-2xl p-8 shadow-lg"
          style={{ backgroundColor: '#83997d' }}
        >
          <h3 className="text-2xl font-bold text-white mb-6">Additional Resources</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-white mb-3">Support Groups & Helplines</h4>
              <ul className="space-y-2 text-white/90">
                <li>
                  <a href="https://www.aa.org/" target="_blank" rel="noopener noreferrer" className="hover:text-[#83997d] underline">
                    Alcoholics Anonymous (AA)
                  </a>
                </li>
                <li>
                  <a href="https://www.na.org/" target="_blank" rel="noopener noreferrer" className="hover:text-[#83997d] underline">
                    Narcotics Anonymous (NA)
                  </a>
                </li>
                <li>
                  <a href="https://al-anon.org/" target="_blank" rel="noopener noreferrer" className="hover:text-[#83997d] underline">
            ...
            <div>
              <h4 className="font-semibold text-white mb-3">Educational Materials</h4>
              <ul className="space-y-2 text-white/90">
                <li>
                  <a href="https://archive.org/details/documentaries" target="_blank" rel="noopener noreferrer" className="hover:text-white underline">
                    Internet Archive - Recovery Documentaries
                  </a>
                </li>
                <li>
                  <a href="https://www.youtube.com/results?search_query=alcohol+recovery+mental+health" target="_blank" rel="noopener noreferrer" className="hover:text-[#83997d] underline">
                    Recovery & Mental Health Resources
                  </a>
                </li>
                <li>
                  <a href="https://www.niaaa.nih.gov/" target="_blank" rel="noopener noreferrer" className="hover:text-[#83997d] underline">
