      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-white to-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow"
          >
            <div className="relative mb-6">
              ...
              <div className="absolute top-4 right-4 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg">
                <span className="text-2xl font-bold text-[#83997d]">1</span>
              </div>
            </div>
            <h3 className="text-2xl font-bold text-[#83997d] mb-4">Physical Recovery</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-[#83997d] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          >
            <div className="relative mb-6">
              ...
              />
              <div className="absolute top-4 right-4 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg">
                <span className="text-2xl font-bold text-[#83997d]">2</span>
              </div>
            </div>
            <h3 className="text-2xl font-bold text-[#83997d] mb-4">Mental Recovery</h3>
            <p className="text-neutral-700 leading-relaxed mb-4">
          ...
          >
            <div className="relative mb-6">
              ...
              />
              <div className="absolute top-4 right-4 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg">
                <span className="text-2xl font-bold text-[#83997d]">3</span>
              </div>
            </div>
            <h3 className="text-2xl font-bold text-[#83997d] mb-4">Spiritual Recovery</h3>
            <p className="text-neutral-700 leading-relaxed mb-4">
